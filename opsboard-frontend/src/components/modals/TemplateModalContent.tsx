...
/**
 * @component TemplateModalContent
 * @description 一个纯粹的、用于显示模板详情内容的展示组件。
 * @param {TemplateModalContentProps} props - 组件的 props。
 * @param {string} props.itemId - 要显示的模板项的 ID。
 * @returns {JSX.Element} - 渲染出的详情内容组件。
 */
